...
function prime_electronic_store_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('prime_electronic_store_theme_width',array(
    'default' => 'full-width',
    'sanitize_callback' => 'prime_electronic_store_sanitize_theme_width'
    ));
    $wp_customize->add_control('prime_electronic_store_theme_width',array(
        'type' => 'select',
        'label' => __('Theme Width Option','prime-electronic-store'),
        'section' => 'prime_electronic_store_general_settings',
        'choices' => array(
            'full-width' => __('Fullwidth','prime-electronic-store'),
            'container' => __('Container','prime-electronic-store'),
            'container-fluid' => __('Container Fluid','prime-electronic-store'),
        ),
    ) );
